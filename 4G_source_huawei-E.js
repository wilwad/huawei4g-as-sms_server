...
/* get list of sms */
var get_sms_list = function(boxtype, pageIdx){
	g_sms_smsListArray.BoxType = boxtype;
    g_sms_smsListArray.PageIndex = pageIdx;
	g_sms_smsListArray.ReadCount = 50;
	g_sms_smsListArray.SortType = 0;
	g_sms_smsListArray.Ascending = 0;
	g_sms_smsListArray.UnreadPreferred = 0;
